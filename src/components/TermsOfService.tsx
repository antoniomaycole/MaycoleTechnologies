      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="text-lg text-gray-300 max-w-3xl mx-auto mb-4">
            ...
            <sup className="text-xs align-super">™</sup> services. These terms govern your use of
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-300">
                    <strong>READ CAREFULLY:</strong> These Terms of Service constitute a legally
                    binding agreement between you and MaycoleTechnologies™. By using our services,
                    you acknowledge that you have read, understood, and agree to be bound by these
                    terms. If you do not agree, you must immediately discontinue use of our
                    services.
                  </p>
                </div>
              </div>
            ...
            <CardContent className="p-8">
              ...
              <ul className="space-y-3 text-gray-300">
                ...
                <li className="flex items-start">
                  <span className="text-green-600 mr-3 mt-1">•</span>
                  <span>
                    You are responsible for backing up your data. We recommend regular exports
                  </span>
                </li>
                <li className="flex items-start">
                  <span className="text-green-600 mr-3 mt-1">•</span>
                  <span>
                    <strong>IMPORTANT:</strong> MaycoleTechnologies™ is NOT designed for storing PII
            ...
            <CardContent className="p-8">
              ...
              <ul className="space-y-3 text-gray-300">
                ...
                <li className="flex items-start">
                  <span className="text-green-600 mr-3 mt-1">•</span>
                  <span>
                    You have 30 days to export your data after termination. After that, data may be
                    deleted
                  </span>
                </li>
                <li className="flex items-start">
                  <span className="text-green-600 mr-3 mt-1">•</span>
                  <span>
                    Sections that should survive termination (e.g., Limitation of Liability) will
                    continue to apply
                  </span>
                </li>
              </ul>
          ...
          <Card className="border-0 bg-card/50 backdrop-blur-sm">
            <CardContent className="p-8">
              ...
              <p className="text-gray-300 mb-4">
                You agree to indemnify and hold harmless MaycoleTechnologies™, its officers,
                directors, employees, and agents from any claims, damages, losses, or expenses
                (including attorney fees) arising from your use of our services, your violation of
            ...
            <CardContent className="p-8">
              ...
              <ul className="space-y-3 text-gray-300">
                ...
                <li className="flex items-start">
                  <span className="text-green-600 mr-3 mt-1">•</span>
                  <span>
                    <strong>Arbitration:</strong> Disputes will be resolved through binding
                    arbitration, not court proceedings
                  </span>
                </li>
                <li className="flex items-start">
                  <span className="text-green-600 mr-3 mt-1">•</span>
                  <span>
                    <strong>Class Action Waiver:</strong> You agree not to participate in class
                ...
                <li className="flex items-start">
                  <span className="text-green-600 mr-3 mt-1">•</span>
                  <span>
                    <strong>Informal Resolution:</strong> Before arbitration, contact us to attempt
                    informal resolution
                  </span>
                </li>
              </ul>
              ...
              <ul className="space-y-3 text-gray-300">
                <li className="flex items-start">
                  ...
                  <span>
                    ...
                    between you and MaycoleTechnologies™
                  </span>
                </li>
                <li className="flex items-start">
                  <span className="text-green-600 mr-3 mt-1">•</span>
                ...
                <li className="flex items-start">
                  <span className="text-green-600 mr-3 mt-1">•</span>
                  <span>
                    <strong>Assignment:</strong> You may not assign these terms. We may assign our
          ...
          <Card className="border-0 bg-card/50 backdrop-blur-sm">
            <CardContent className="p-8">
              ...
              <div className="space-y-2 text-gray-300">
                ...
                <p>
                  <strong>Legal Inquiries:</strong> legal@maycoletechnologies.com
                </p>
                <p>
