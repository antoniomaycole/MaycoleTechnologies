...
const faqs: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      'Most implementations are completed within 2-4 weeks. Our agile methodology allows us to deploy core functionality quickly, then iterate based on your specific needs. For MaycoleTracker™, basic setup can be done in as little as 48 hours, with full customization completed within 2 weeks. We provide white-glove onboarding and dedicated support throughout.',
    category: 'technical',
    icon: Clock,
  },
  {
  ...
  },
  {
    ...
    answer:
      "You maintain full ownership of your data always. If you cancel, you can export all your data in standard formats (CSV, JSON, Excel) for 90 days after cancellation. We'll never hold your data hostage. After 90 days, data is permanently deleted from our servers per our data retention policy. You can request a complete data export at any time during your active subscription.",
    category: 'security',
    icon: Lock,
  },
  {
  ...
  },
  {
    ...
    answer:
      'Absolutely! You can start free trials for both products simultaneously. Many of our clients use both solutions together for complete business management. We offer bundle pricing for combined subscriptions - contact our sales team for custom bundle quotes that can save you up to 25% compared to individual subscriptions.',
    category: 'pricing',
    icon: CreditCard,
  },
];
      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            ...
            <span className="maycole-trademark">™</span> and our products
          </p>
        </motion.div>
          ...
          <Card className="maycole-card max-w-2xl mx-auto bg-gradient-to-br from-maycole-green/5 to-maycole-gold/5 border-2 border-maycole-green/20">
            <CardContent className="p-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="#contact" className="maycole-btn-primary inline-block px-8 py-3">
                  Contact Our Team
                </a>
                <a
                  href="#free-trial"
