          ...
          >
            <div className="bg-gradient-to-r from-green-50 via-white to-yellow-50 rounded-xl p-4 border border-green-100/50 shadow-sm">
              <p className="text-base font-medium bg-gradient-to-r from-green-700 to-yellow-600 bg-clip-text text-transparent">
                The FIRST truly AI-native, voice-controlled, universal inventory management system.
                Choose your plan and revolutionize your inventory management today.
              </p>
            </div>
          </motion.div>
        </motion.div>
            ...
            >
              ...
              >
                ...
                <CardHeader className="text-center pb-3">
                  <div
                    className={`w-12 h-12 bg-gradient-to-br ${plan.color} rounded-xl flex items-center justify-center mb-3 mx-auto shadow-md`}
                  >
                    <AtomicLogo size="xs" />
                  </div>
              ...
              {selectedPlanData && (
                <div className="mt-3 p-3 bg-gradient-to-r from-green-50 to-yellow-50 rounded-lg">
                  <p className="text-base">
                    ...
                    <span className="ml-3 text-xl font-bold text-yellow-600">
                  ...
                  <div className="text-center py-8">
                    <div className="bg-blue-50 rounded-2xl p-8">
                      ...
                      <div className="space-y-2 text-sm text-gray-600">
                        <p>
                          📧 PayPal Email: help@maycoletechnologies
                          <sup className="text-xs align-super">™</sup>.com
                        </p>
                    ...
                    <div className="bg-purple-50 rounded-2xl p-8">
                      ...
                      <div className="bg-white rounded-lg p-4 border-2 border-purple-200 mb-4">
                        ...
                        <p className="text-purple-600 font-mono text-lg">
                          help@maycoletechnologies<sup className="text-xs align-super">™</sup>.com
                        </p>
                ...
                <TabsContent value="cashapp" className="space-y-6">
                  <div className="text-center py-8">
                    <div className="bg-green-50 rounded-2xl p-8">
                      ...
                      <p className="text-gray-600 mb-6">Quick and easy payment through Cash App</p>
                ...
                {selectedPlanData && (
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between text-xs text-gray-600">
                      ...
                      <span>
                        {paymentMethods.find((m) => m.id === paymentMethod)?.processingFee}
                      </span>
                    </div>
