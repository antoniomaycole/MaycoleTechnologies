      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Join thousands of companies transforming their operations with{' '}
                  ...
                  <CardContent className="p-8">
                    ...
                    <div className="flex items-center gap-4 pt-6 border-t border-gray-200">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-maycole-green font-medium">
                          {testimonial.company}
                        </div>
                      </div>
                    </div>
                  ...
                  <CardContent className="p-6">
                    ...
                    {testimonial.metric && (
                      <div className="bg-maycole-green/10 rounded-lg p-2 mb-4 text-center">
                        ...
                        <div className="text-sm font-bold text-maycole-green">
