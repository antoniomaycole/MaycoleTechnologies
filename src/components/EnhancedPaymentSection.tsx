...
const PricingCard = React.forwardRef<HTMLDivElement, PricingCardProps>(
  ({ tierId, isAnnual = false, onSelectPlan, isLoading = false }, ref) => {
    ...
    const handleSelectPlan = async () => {
      ...
      if (tierId === 'trial') {
        ...
        analytics.trackEvent('pricing', 'trial_selected', { tierId });
      ...
      const analytics = getAnalytics();
      analytics.trackEvent('pricing', 'plan_selected', {
        tierId,
 ...
 */
export const EnhancedPaymentSection = React.forwardRef<HTMLDivElement>(
  (_, ref) => {
    ...
    const handleSelectPlan = async (tierId: string, email: string) => {
      ...
      try {
        ...
        if (tierId === 'trial') {
          const analytics = getAnalytics();
          analytics.trackEvent('pricing', 'trial_initiated', { email });
          toast.success(
            'Welcome to Maycole Tracker! Check your email to get started.'
          );
