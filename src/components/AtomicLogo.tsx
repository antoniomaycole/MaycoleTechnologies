  ...
  return (
    <div className={`atomic-logo-component relative flex items-center justify-center ${logoSize}`}>
      <span
        ...
        style={{
          fontFamily:
            'ui-monospace, "Cascadia Code", "Roboto Mono", Menlo, Monaco, "Lucida Console", "Liberation Mono", "DejaVu Sans Mono", "Bitstream Vera Sans Mono", "Courier New", monospace',
          fontWeight: '600',
      ...
      <div
        className={`relative ${containerSize} mx-1 flex items-center justify-center`}
        style={{
          perspective: '1000px',
          ...
          <>
            ...
            <motion.div
              ...
              style={{
                ...
                boxShadow:
                  '0 0 50px rgba(34, 197, 94, 0.15), inset 0 0 50px rgba(34, 197, 94, 0.05)',
            ...
            <motion.div
              ...
              style={{
                ...
                borderImage:
                  'conic-gradient(from 0deg, #22c55e, #ffd700, #22c55e, #ffd700, #22c55e) 1',
                transform: 'translateZ(-20px)',
              }}
              animate={{
                scale: [0.8, 1.3, 0.8],
