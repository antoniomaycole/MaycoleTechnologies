      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="text-lg text-gray-300 max-w-3xl mx-auto mb-4">
            ...
            <sup className="text-xs align-super">™</sup> uses them, 
          ...
          <Card className="border-0 bg-card/50 backdrop-blur-sm">
            <CardContent className="p-8">
              ...
              <p className="text-gray-300 mb-4">
                ...
                visit a website. They help websites remember information about your visit, making your next 
        ...
        >
          <Card className="border-0 bg-card/50 backdrop-blur-sm">
            <CardContent className="p-8">
              ...
              <p className="text-gray-300 mb-4">
                In addition to our own cookies, we use third-party services that may set cookies on your device:
              </p>
          ...
          <Card className="border-0 bg-card/50 backdrop-blur-sm">
            <CardContent className="p-8">
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="text-xl font-semibold mb-3 text-green-600">Option 1: Cookie Consent Banner</h3>
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-3 text-green-600">Option 2: Browser Settings</h3>
                  <p className="text-gray-300 mb-2">
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-3 text-green-600">Option 3: Do Not Track</h3>
                  <p className="text-gray-300">
                    Most browsers support "Do Not Track" (DNT) settings. However, there is no universal 
                    standard for DNT, and we may not respond to DNT signals. We recommend using the cookie 
                    consent banner or browser settings instead.
                  </p>
                </div>
              </div>
            </CardContent>
