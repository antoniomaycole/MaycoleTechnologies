  ...
  const trackerFeatures = [
    {
      ...
      description:
        'Built from the ground up with artificial intelligence at its core, providing intelligent insights and automated decision-making capabilities.',
    },
    {
      icon: Mic,
      title: 'Voice Control & Commands',
      description:
        'Revolutionary hands-free voice commands for seamless inventory management in any environment, supporting natural language processing.',
    },
    {
      icon: Scan,
      title: 'Barcode Scanning',
      description:
        'Advanced barcode and QR code scanning with real-time recognition and automatic data capture for lightning-fast inventory updates.',
    },
    {
      icon: WifiOff,
      title: 'Offline Functionality',
      description:
        'Full PWA capabilities with robust offline mode, ensuring continuous operation even without internet connectivity.',
    },
    {
      icon: Globe,
      title: 'Multi-Device Support',
      description:
        'Native support for iOS, Android, and desktop platforms with seamless synchronization across all devices.',
    },
    {
      icon: Database,
      title: 'Real-Time Tracking',
      description:
        'Instant updates and real-time inventory visibility with live data synchronization across all connected systems.',
    },
    {
      icon: BarChart3,
      title: 'Advanced Analytics',
      description:
        'Comprehensive reporting and analytics with predictive insights, trend analysis, and performance optimization recommendations.',
    },
    {
      icon: Bell,
      title: 'Emergency Mode',
      description:
        'Critical alert system with emergency mode functionality for urgent inventory situations and crisis management.',
    },
    {
      icon: Shield,
      title: 'Enterprise Security',
      description:
        'Bank-level encryption, audit trails, and compliance with FDA, OSHA, and other industry regulations for maximum security.',
    },
  ];
  ...
  const checkbookFeatures = [
    {
      ...
      description:
        'Intelligent parsing and categorization of transactions using advanced AI to understand natural language inputs and automatically organize your finances.',
    },
    {
      icon: Mic,
      title: 'Voice-Enabled Entry',
      description:
        'Speak your transactions naturally and watch as AI instantly captures payee, amount, category, and transaction type with visual feedback indicators.',
    },
    {
      icon: ArrowUpDown,
      title: 'Smart Sorting System',
      description:
        'Advanced multi-column sorting for dates (chronological), amounts (numerical), and text fields (alphabetical) with intuitive visual indicators.',
    },
    {
      icon: TrendingUp,
      title: 'Intelligent Insights',
      description:
        'Real-time financial analytics with spending patterns, budget tracking, and predictive forecasting to optimize your money management.',
    },
    {
      icon: Tags,
      title: 'Auto-Categorization',
      description:
        'Automatically categorize expenses and income with machine learning that adapts to your spending habits and financial patterns.',
    },
    {
      icon: Receipt,
      title: 'Digital Ledger',
      description:
        'Complete transaction history with searchable records, detailed entries, and comprehensive audit trails for perfect financial clarity.',
    },
    {
      icon: PieChart,
      title: 'Visual Reporting',
      description:
        'Beautiful charts and graphs showing spending breakdowns, income trends, and budget performance at a glance.',
    },
    {
      icon: Shield,
      title: 'Bank-Level Security',
      description:
        'Military-grade encryption, secure data storage, and compliance with financial industry standards to protect your sensitive information.',
    },
    {
      icon: Smartphone,
      title: 'Cross-Platform Sync',
      description:
        'Seamless synchronization across all your devices with real-time updates and offline capability for managing finances anywhere.',
    },
  ];
        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-white max-w-3xl mx-auto">
              Enterprise-grade solutions powered by AI, designed to transform your business
              operations
            </p>
          </motion.div>
              ...
              <div className="relative z-10">
                ...
                >
                  <h1 className="text-5xl md:text-7xl font-bold mb-4 flex items-center justify-center gap-3">
                    <CheckbookIcon className="w-12 h-12 text-green-400" />
                ...
                <motion.div
                  ...
                  className="mb-8"
                >
                  <Button className="bg-gradient-to-r from-green-600 to-yellow-500 hover:from-green-700 hover:to-yellow-600 text-white px-12 py-6 text-xl font-medium group relative overflow-hidden border-none shadow-2xl">
                    <div className="flex items-center gap-3">
                      <CheckbookIcon className="w-6 h-6 text-white" />
                      Coming Soon
                    </div>
                ...
                >
                  <p>
                    Features: AI Transaction Parsing • Voice Entry • Multi-Column Sorting • Budget
                    Tracking
                  </p>
                </motion.div>
              </div>
                  ...
                  <Button
                    onClick={() => {
                      if (onLaunchTracker) {
                        ...
                        console.warn('[ProductsSection] onLaunchTracker prop not provided');
                      }
                    }}
          ...
          >
            <div className="text-center mb-16">
              <div className="flex items-center justify-center mb-6">
                <TrackerIcon size={48} animated={false} />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {trackerFeatures.map((feature, index) => {
                ...
                return (
                  ...
                  >
                    <Card
                      className={`maycole-card h-full group ${isFirstFeature ? 'ring-2 ring-blue-500/30' : ''}`}
                    >
                      <CardHeader className="pb-4">
                        ...
                        <CardTitle
                          className={`text-xl font-bold ${isFirstFeature ? 'text-blue-300' : 'text-white'}`}
                        >
                          <div className="flex items-center gap-2">
                            {feature.title}
                            {isFirstFeature && (
                              <>
                                <TrackerIcon size={24} animated={false} interactive={true} />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {checkbookFeatures.map((feature, index) => {
                ...
                return (
                  ...
                  >
                    <Card
                      className={`maycole-card h-full group ${isFirstFeature ? 'ring-2 ring-green-500/30' : ''}`}
                    >
                      <CardHeader className="pb-4">
                        <div
                          className={`w-14 h-14 rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300 relative ${
                        ...
                        <CardTitle
                          className={`text-xl font-bold ${isFirstFeature ? 'text-green-300' : 'text-white'}`}
                        >
                          <div className="flex items-center gap-2">
                            {feature.title}
                            {isFirstFeature && (
          ...
          >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              {subscriptionTiers.map((tier, index) => (
                ...
                >
                  <Card
                    className={`maycole-card h-full ${tier.highlighted ? 'border-blue-500 shadow-xl bg-gradient-to-br from-blue-950/50 to-blue-900/50' : ''}`}
                  >
                    <CardHeader className="text-center pb-6">
                      ...
                      <CardTitle
                        className={`text-2xl font-bold mb-2 ${tier.highlighted ? 'text-blue-300' : 'text-maycole-green'}`}
                      >
                        {tier.name}
                      </CardTitle>
                      <div className="mb-4">
                        ...
                        <span
                          className={`ml-2 ${tier.highlighted ? 'text-blue-300' : 'text-maycole-gold'}`}
                        >
                          / {tier.period}
                        </span>
                      </div>
                    ...
                    <CardContent>
                      <div className="space-y-3 mb-8">
                        {tier.features.map((feature, idx) => (
                          <div key={idx} className="flex items-center gap-3">
                            <CheckCircle
                              className={`w-5 h-5 flex-shrink-0 ${tier.highlighted ? 'text-blue-400' : 'text-maycole-green'}`}
                            />
                      ...
                      <Button
                        ...
                        onClick={() => {
                          if (tier.highlighted && onLaunchTracker) {
                            onLaunchTracker();
            ...
            <Card className="maycole-card border-green-500/30">
              <CardContent className="p-8 text-center">
                <div className="flex flex-col items-center gap-4">
                  ...
                  <h3 className="text-2xl font-bold text-white">Questions About Our Products?</h3>
                  <p className="text-white max-w-2xl">
                    Our team is here to help you choose the right solution for your business.
                    Whether you need guidance on MaycoleCheckBook™ or MaycoleTracker™, we're ready
                    to assist.
                  </p>
                  <a
          ...
          >
            <div className="bg-gradient-to-r from-green-950 via-green-900 to-yellow-900 rounded-3xl p-12 text-white relative overflow-hidden border border-green-500/30">
              <div className="relative z-10">
                <div className="flex items-center justify-center mb-6">
                  <CheckbookIcon className="w-16 h-16 text-green-400" animated={false} />
                  <h3 className="text-3xl md:text-4xl font-bold ml-4">
                    🚀 Join the AI Revolution - Transform Your Business Today
                  </h3>
                </div>
                <p className="text-xl mb-8 max-w-2xl mx-auto opacity-90">
                  Experience intelligent automation with{' '}
                  <span className="text-green-300 font-semibold">MaycoleCheckBook™</span> - The
                  future of AI-powered financial management. Plus explore{' '}
                  <span className="text-blue-300 font-semibold">MaycoleTracker™</span> for inventory
                  intelligence.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Button className="bg-gradient-to-r from-green-600 to-yellow-500 hover:from-green-700 hover:to-yellow-600 text-white px-8 py-4 font-medium text-lg group border-none">
                    <div className="flex items-center gap-3">
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <TrackerIcon size={20} animated={false} interactive={false} />
