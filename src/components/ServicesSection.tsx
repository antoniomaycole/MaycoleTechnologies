          ...
          >
            <div className="bg-black rounded-2xl p-8 border border-green-500/30 shadow-lg backdrop-blur-sm">
              ...
              <blockquote className="text-xl md:text-2xl font-medium leading-relaxed bg-gradient-to-r from-green-700 via-green-600 to-yellow-600 bg-clip-text text-transparent">
                "<span className="maycole-gradient-text">MaycoleTechnologies</span><sup className="maycole-trademark">™</sup> isn't just a tech brand—it's a legacy in motion. We're architecting systems that belong on the public stage, powered by founder-grade logic and IP-aware execution."
              </blockquote>
        ...
        >
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-300 max-w-4xl mx-auto">
              Our dedicated team of Agile professionals brings together expertise, innovation, and proven methodologies 
              to deliver exceptional results. Meet the specialists who make your vision a reality.
            </p>
          </div>
              ...
              return (
                ...
                >
                  <Card className="h-full relative overflow-hidden border-0 bg-gradient-to-br from-white to-gray-50/50 backdrop-blur-sm hover:shadow-2xl transition-all duration-500 group">
                    <div className={`absolute inset-0 bg-gradient-to-br ${member.bgColor} opacity-0 group-hover:opacity-100 transition-opacity duration-500`}></div>
                    
                    <CardHeader className="relative z-10 pb-4">
                      <div className={`w-16 h-16 bg-gradient-to-br ${member.color} rounded-2xl flex items-center justify-center mb-4 shadow-lg group-hover:scale-110 transition-transform duration-300`}>
                        <AtomicLogo size="sm" />
                      </div>
                    ...
                    <CardContent className="relative z-10 pt-0">
                      ...
                      {/* Decorative elements */}
                      <div className={`absolute -bottom-4 -right-4 w-20 h-20 bg-gradient-to-br ${member.color} opacity-10 rounded-full group-hover:scale-150 group-hover:opacity-20 transition-all duration-500`}></div>
                      <div className={`absolute -top-2 -left-2 w-12 h-12 bg-gradient-to-br ${member.color} opacity-5 rounded-full group-hover:scale-125 transition-all duration-500`}></div>
                    </CardContent>
